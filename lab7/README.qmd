...
author: "smartascheeseburger@yandex.ru"
format: 
  md:
...
В ходе работы выполнен детальный анализ данных пакета tm_data, успешно реализованы все поставленные задачи исследования.

## Вывод

Практическая работа позволила освоить современные методы работы с облачными технологиями для обработки данных, а также получить опыт анализа сетевого трафика на основе метаданных.